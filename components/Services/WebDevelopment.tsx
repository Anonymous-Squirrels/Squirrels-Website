      ...
      <div className='flex flex-col gap-7 items-center justify-center'>
        <div className='relative px-5 pt-14 pb-5 mt-10 md:mt-24 bg-[#111111] rounded-xl'>
          ...
          <div className='flex flex-col gap-y-5 w-full'>
            ...
            <p className='text-[#969696] text-center'>
              We craft <span className="text-[#c4c2c2] font-extrabold">scalable, high-performance</span> solutions using MongoDB, Express, React, and Node.js to meet your 
              <span className="text-[#c4c2c2] font-extrabold"> business needs</span>. We focus on creating <span className="text-[#c4c2c2] font-extrabold"> easy-to-use, effective tools </span> that help your business grow and 
              succeed.
            </p>
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-7 max-w-[1244px]'>
          <div className='relative p-5 bg-[#111111] rounded-xl'>
            <div className='flex flex-col gap-y-5 max-w-2xl items-center'>
              ...
              <div className='text-[#969696] text-center'>
                ...
                <span className="text-[#c4c2c2] font-extrabold"> React.js and Next.js </span> development services.
              </div>
            </div>
          </div>
          ...
          <div className='relative p-5 bg-[#111111] rounded-xl'>
            <div className='flex flex-col gap-y-5 max-w-2xl items-center'>
              ...
              <div className='text-[#969696] text-center'>
                Custom store designs to powerful integrations, we create<span className="text-[#c4c2c2] font-extrabold"> user-friendly</span>, conversion- <span className="text-[#c4c2c2] font-extrabold"></span>optimized online stores
                that drive sales and enhance your <span className="text-[#c4c2c2] font-extrabold">e-commerce brand</span>.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='relative p-5 bg-[#111111] rounded-xl'>
          <div className='flex flex-col gap-y-5 items-center'>
            ...
            <div className='text-[#969696] text-center'>
              Step into your basic online presence with our <span className="text-[#c4c2c2] font-extrabold"> custom WordPress </span> solutions & stands out in a 
              crowded <span className="text-[#c4c2c2] font-extrabold"> digital landscape </span> with our <span className="text-[#c4c2c2] font-extrabold"> Wordpress and Wix Studio </span> solutions to stand out in a crowded
            </div>
          </div>
        </div>
      </div>
