      ...
      >
        ...
        <p
          className={`${isHome ? "md:ml-[32px]  4xl:text-xl" : "mx-5  text-xl "
            } ml-[9px] sm:ml-[12.92px]  2xl:mt-[46px] mb-1 lg:mt-[44px] md:mt-[35px] sm:mt-[25.83px] mt-[12.35px] text-[#7d8590] duration-500 transition text-base group-hover:text-white 4xl:text-lg leading-[25px]`}
        >
          {about}
        </p>
      </div>
